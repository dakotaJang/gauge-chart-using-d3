...
class GaugeChart {
    constructor(value, options) {
        ...
        const { innerRadius, tickLabelFontSize } = Object.assign({ tickLabelFontSize: 16, innerRadius: 0.7 * width / 2 }, options);
        const { min, max, sections, backgroundSectionColor, displayMajorTickLabels, displayValue, minAngle, maxAngle, outerRadius, needleRadius, needleColor, needlePinColor, minorTickStep, majorTickStep, tickDirection, majorTickHeight, minorTickHeight, majorTickWidth, minorTickWidth, tickColor, tickRadius, tickLabelRadius, valueLabelFontSize, } = Object.assign({ sections: [], minAngle: -Math.PI * 3 / 4, maxAngle: Math.PI * 3 / 4, tickColor: '#000', needleColor: '#000', needlePinColor: '#000', needleRadius: 0.9 * width / 2, outerRadius: width / 2, majorTickHeight: 10, minorTickHeight: 5, majorTickWidth: 3, minorTickWidth: 1, tickDirection: 'in', tickRadius: width / 2, tickLabelRadius: innerRadius - tickLabelFontSize, displayValue: true, valueLabelFontSize: 16, width: 200 }, options);
        const height = width;
        const gaugeArc = arc().innerRadius(innerRadius).outerRadius(outerRadius);
